...
// Funcion que muestra los datos ya obtenidos y formateados 
    ...
    addRow() {
        let row = [];
        const {n, type} = this.state;

        for (var i = 0; i < n; i++) {
            row.push(
                <div>
                    <h6>{i}</h6>
                    <Add key={i} type={type} handleSelectedDistributions={this.handleSelectedDistributions}/>
                </div>
            );
        }
        return row;
            ...
            <div className="main_block">
                ...
                <div className="options_block">
                    ...
                    <div className="add_block position">
                        ...
                        <button onClick={this.handleOnAdd} type="button" class="btn btn-primary btn-secondary">+
                        </button>
                        {this.addRow()}
                        <button onClick={this.handleOnRemove} type="button" class="btn btn-primary btn-secondary">-
                        </button>
                    </div>
                    <div className="samples_block position">
                        ...
                        <button onClick={this.handleOnCharts} type="button" class="btn btn-success">Press when u are
                            ready
                        </button>
